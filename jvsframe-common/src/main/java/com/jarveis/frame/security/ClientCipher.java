...
public class ClientCipher {
	 ...
	 * @return
	 */
	public static String[] reqSession(String fileName, String content) {
		String[] result = new String[3];

		try {
			String key = UUID.randomUUID().toString().replaceAll("-", "");
			String contentCipher = DESCipher.encrypt(content.getBytes(), key);
	 ...
	 * @return
	 */
	public static String[] respSession(String fileName, String contentCipher,
			String keyCipher) {
	 ...
	 * @return
	 */
	public static String[] reqService(String fileName, String content) {
		String[] result = new String[3];
	 ...
	 * @return
	 */
	public static String[] respService(String fileName, String contentCipher,
			String keyCipher) {
		String[] result = new String[2];
