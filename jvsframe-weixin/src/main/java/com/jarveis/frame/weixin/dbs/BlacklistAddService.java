 ...
 *
 * @author liuguojun
 * @see WeixinURL#ADD_BLACKLIST
 * @since 2021-10-18
 */
public class BlacklistAddService implements Service, WeixinCallback, WeixinAccessToken {

    private static final Logger log = LoggerFactory.getLogger(BlacklistAddService.class);
    ...
    public Param callService(Param in) {
        ...
        try {
            ...
            // 请求接口
            String postURL = String.format(WeixinURL.ADD_BLACKLIST, accessToken);
