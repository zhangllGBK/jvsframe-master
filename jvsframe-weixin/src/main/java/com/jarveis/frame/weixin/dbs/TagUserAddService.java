 ...
 *
 * @author liuguojun
 * @see WeixinURL#ADD_TAG_USER
 * @since 2021-10-18
 */
public class TagUserAddService implements Service, WeixinCallback, WeixinAccessToken {

    private static final Logger log = LoggerFactory.getLogger(TagUserAddService.class);
    ...
    public Param callService(Param in) {
        ...
        try {
            ...
            // 请求接口
            String postURL = String.format(WeixinURL.ADD_TAG_USER, accessToken);
