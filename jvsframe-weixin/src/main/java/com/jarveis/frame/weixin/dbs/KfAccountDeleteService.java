 ...
 *
 * @author liuguojun
 * @see WeixinURL#DELETE_CUSTOM_KFACCOUNT
 * @since 2021-06-16
 */
public class KfAccountDeleteService implements Service, WeixinCallback, WeixinAccessToken {

    private static final Logger log = LoggerFactory.getLogger(KfAccountDeleteService.class);
    ...
    public Param callService(Param in) {
        ...
        try {
            ...
            if (StringUtils.isAnyEmpty(kf_account)) {
            ...
            // 请求接口
            String getURL = String.format(WeixinURL.DELETE_CUSTOM_KFACCOUNT, accessToken, kf_account);
