 ...
 *
 * @author liuguojun
 * @see WeixinURL#DELETE_BLACKLIST
 * @since 2021-10-18
 */
public class BlacklistDeleteService implements Service, WeixinCallback, WeixinAccessToken {

    private static final Logger log = LoggerFactory.getLogger(BlacklistDeleteService.class);
    ...
    public Param callService(Param in) {
        ...
        try {
            ...
            // 请求接口
            String postURL = String.format(WeixinURL.DELETE_BLACKLIST, accessToken);
